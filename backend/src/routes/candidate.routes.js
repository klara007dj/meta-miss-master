...
const { likeRateLimiter, candidacyRateLimiter } = require("../middlewares/rateLimiter");
...
router.post("/register", candidacyRateLimiter, authenticate, upload.single("photo"), candidateValidation, candidateController.register);
