  ...
  return (
    <div className="page-content fade-up">
      <div className="top-bar">
        ...
        <span className="top-bar-title">Mes votes</span>
        <div style={{ width: 32 }} />
      </div>

      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "60px 20px", textAlign: "center" }}>
        <div style={{ fontSize: "2.5rem", marginBottom: 16 }}>🗳️</div>
        <div style={{ fontWeight: 700, color: "var(--text)", marginBottom: 8 }}>Aucun vote pour l'instant</div>
        <div style={{ fontSize: "0.84rem", color: "var(--text-muted)" }}>Vos votes apparaîtront ici après paiement.</div>
      </div>
