      ...
      <div className="candidate-layout">
        ...
        <div className="candidate-photo-wrap">
          ...
          <button onClick={toggleLike} style={{
            ...
            cursor: "pointer", boxShadow: "0 2px 12px rgba(0,0,0,.18)",
            transition: "transform .2s",
          }}
            onMouseEnter={e => (e.currentTarget as HTMLButtonElement).style.transform = "scale(1.1)"}
            onMouseLeave={e => (e.currentTarget as HTMLButtonElement).style.transform = "scale(1)"}
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill={liked ? "#EF4444" : "none"} stroke={liked ? "#EF4444" : "#6B7280"} strokeWidth="2">
              <path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z" />
            </svg>
          </button>

          {/* Vote count bottom-left */}
          <div style={{
